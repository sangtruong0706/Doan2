 ...
 <!-- jQuery-V1.12.4 -->
 <script>
     // hằng để gọi tới thẻ show-modal
     const openModal = document.querySelector('.show-modal');

     // hằng để gọi tới modal
     const modal = document.querySelector('.modal');

     // hằng để gọi tới close-btn
     const closeIcon = document.querySelector('.close-btn');

     // hàm hiển thị modal, add class open vào modal
     function showModal() {
         modal.classList.add('open');
     }

     // hàm ẩn modal, remove class open khỏi modal
     function hideModal() {
         modal.classList.remove('open');
     }

     // hành động lắng nghe click sẽ mở modal khi bấm vô bảng "bấm vô để hiển thị"
     openModal.addEventListener('click', showModal)

     // hành động lắng nghe click sẽ ẩn modal khi bấm vô bảng nút đóng
