...
<div class="container">
    <?php
    if(Session::get('message') && Session::get('message')=='Username or Password không chính xác!!!') {
        $color = 'warning';
    }else{
        $color = 'success';
    }
                    ...
                    <div class="login-form">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-12 mb-20">
                                ...
                                <input class="mb-0" type="email" placeholder="Email Address" name="username" value="<?=$user?>">
                            </div>
                            <div class="col-12 mb-20">
                                <label>Password</label>
                                <input class="mb-0" type="text" placeholder="Password" name="password" value="<?=$pass?>" >
                            </div>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4 mt-10 mb-20 text-left text-md-right">
                                <a href="<?=BASE_URL?>/customer/forgotPass"> Forgotten pasward?</a>
                            </div>
                            <div class="col-md-12">
